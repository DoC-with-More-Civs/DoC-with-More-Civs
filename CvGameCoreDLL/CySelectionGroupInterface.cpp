...
void CySelectionGroupInterface()
{
	...
	boost::python::class_<CySelectionGroup>("CySelectionGroup")
		...
		.def("lastMissionPlot", &CySelectionGroup::lastMissionPlot, boost::python::return_value_policy<boost::python::manage_new_object>(), "CvPlot* ()")
		...
		.def("getPathFirstPlot", &CySelectionGroup::getPathFirstPlot, boost::python::return_value_policy<boost::python::manage_new_object>(), "CyPlot* ()")
		.def("getPathEndTurnPlot", &CySelectionGroup::getPathEndTurnPlot, boost::python::return_value_policy<boost::python::manage_new_object>(), "CyPlot* ()")
		...
		.def("getMissionFromQueue", &CySelectionGroup::getMissionFromQueue, boost::python::return_value_policy<boost::python::manage_new_object>(), "MissionData* (int iIndex)")
		.def("getHeadUnit", &CySelectionGroup::getHeadUnit, boost::python::return_value_policy<boost::python::manage_new_object>(), "CyUnit* ()")
		.def("getUnitAt", &CySelectionGroup::getUnitAt, boost::python::return_value_policy<boost::python::manage_new_object>(), "CyUnit* (int index)")
