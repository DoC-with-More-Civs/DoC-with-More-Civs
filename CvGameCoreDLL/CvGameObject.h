...
public:
	...
	virtual void* addPythonArgument(CyArgsList* argList) = 0;
...
public:
	CvGameObjectGame() {}
	virtual GameObjectTypes getGameObjectType() const { return GAMEOBJECT_GAME; }
	virtual CvProperties* getProperties() const;
	virtual CvProperties* getPropertiesConst() const;
	...
	virtual void* addPythonArgument(CyArgsList* argList);
...
{
public:
	CvGameObjectTeam(CvTeam* pTeam) { m_pTeam = pTeam; }
	virtual GameObjectTypes getGameObjectType() const { return GAMEOBJECT_TEAM; }
	virtual CvProperties* getProperties() const;
...
{
public:
	CvGameObjectPlayer(CvPlayer* pPlayer) { m_pPlayer = pPlayer; }
...
{
public:
	CvGameObjectCity(CvCity* pCity) { m_pCity = pCity; }
	virtual GameObjectTypes getGameObjectType() const;
	virtual CvProperties* getProperties() const;
	virtual const CvProperties* getPropertiesConst() const;
	virtual void foreach(GameObjectTypes eType, boost::function<void(CvGameObject *)> func);
...
{
public:
	CvGameObjectUnit(CvUnit* pUnit) { m_pUnit = pUnit; }
	virtual GameObjectTypes getGameObjectType() const;
	virtual CvProperties* getProperties() const;
	virtual const CvProperties* getPropertiesConst() const;
	virtual void foreach(GameObjectTypes eType, boost::function<void(CvGameObject *)> func);
...
{
public:
	CvGameObjectPlot(CvPlot* pPlot) { m_pPlot = pPlot; }
	virtual GameObjectTypes getGameObjectType() const;
	virtual CvProperties* getProperties() const;
	virtual const CvProperties* getPropertiesConst() const;
	virtual void foreach(GameObjectTypes eType, boost::function<void(CvGameObject *)> func);
	...
	virtual CvGameObjectPlayer* getOwner();
	virtual CvGameObjectPlot* getPlot();
	virtual CvGameObjectTeam* geteTeam();
