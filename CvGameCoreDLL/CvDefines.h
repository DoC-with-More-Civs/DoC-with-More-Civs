...
#ifdef _USRDLL
#define MAX_CIV_PLAYERS												(74) //Rhye, Leoreth: +17 for Byzantium, Korea, Indonesia, Mughals, Thailand, Seljuks, Prussia/HRE, Italy, Tamils, Poland, Moors, Congo, Tibet, Brazil, Argentina, Canada, Polynesia, Harappa
#else
