...
void CyGlobalContextPythonInterface1(boost::python::class_<CyGlobalContext>& x)
{
	...
	x
		...
		.def("getTurnTimerInfo", &CyGlobalContext::getTurnTimerInfo, boost::python::return_value_policy<boost::python::reference_existing_object>(), "(TurnTimer Info) - CvInfo for TurnTimerID")
		...
		.def("getBuildingClassInfo", &CyGlobalContext::getBuildingClassInfo, boost::python::return_value_policy<boost::python::reference_existing_object>(), "(BuildingClassID) - CvInfo for BuildingClassID")
		...
		.def("getUnitClassInfo", &CyGlobalContext::getUnitClassInfo, boost::python::return_value_policy<boost::python::reference_existing_object>(), "(UnitClassID) - CvInfo for UnitClassID")
