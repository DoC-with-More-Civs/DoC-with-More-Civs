...
public:
	...
	void setWallOverridePoints(const boost::python::tuple& kPoints); /* points are given in world space ... i.e. PlotXToPointX, etc */
	boost::python::tuple getWallOverridePoints() const;
