...
/*******************************/
	...
	virtual void setAllPlotTypes(PlayerTypes ePlotType) = 0;	// Exposed to Python
	...
	virtual CvPlot* syncRandPlot(int iFlags = 0, int iArea = -1, int iMinUnitDistance = -1, int iTimout = 100) = 0; // Exposed to Python

	virtual CvCity* findCity(int iX, int iY, PlayerTypes eOwner = NO_PLAYER, TeamTypes eTeam = NO_TEAM,
		bool bSameArea = true, bool bCoastalOnly = false, TeamTypes eTeamAtWarWith = NO_TEAM,
		DirectionTypes eDirection = NO_DIRECTION, CvCity* pSkipCity = NULL) = 0; // Exposed to Python
	
	virtual CvSelectionGroup* findSelectionGroup(int iX, int iY, PlayerTypes eOwner = NO_PLAYER,
		bool bReadyToSelect = false, bool bWorkers = false) = 0;	// Exposed to Python

	virtual CvArea* findBiggestArea(bool bWater) = 0;	// Exposed to Python

	virtual int getMapFractalFlags() = 0;
	...
	virtual CustomMapOptionTypes getCustomMapOption(int iPption) = 0;	// Exposed to Python
